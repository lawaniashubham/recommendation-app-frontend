  ...
  return (
    <div style = {{marginLeft:"auto", marginRight:"auto", width : "50%", marginTop:"20vh"}}>
      ...
      {data.map((item) => {
          ...
          if (item.filter === "htmlcss") {
            // Replace this with the actual rendering logic for the filtered data
            return (<div style = {{marginTop:"auto", backgroundColor:"lightblue"}}key={item.id}>
              ...
              <h1 style={{textAlign:"center"}}>{item.recomm_name}</h1>
      ...
      <br></br>
      <h1 style={{backgroundColor:"red"}}>Don't think so, please recommend us ! </h1> 
    </div>
    
  );
};

export default HtmlCssRecommendPage;
